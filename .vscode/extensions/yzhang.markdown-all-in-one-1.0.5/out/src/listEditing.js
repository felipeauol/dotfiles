...
function onBackspaceKey() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (/^\s+([-+*]|[0-9]+[.)]) (|\[[ x]\] )$/.test(textBeforeCursor)) {
            ...
            return deleteRange(editor, new vscode_1.Range(newPosition.with({ character: 0 }), newPosition));
        }
        else if (/^([-+*]|[0-9]+[.)]) (\[[ x]\] )$/.test(textBeforeCursor)) {
            // e.g. textBeforeCursor == '- [ ]', '1. [x]'
            return deleteRange(editor, new vscode_1.Range(newPosition.with({ character: textBeforeCursor.length - 4 }), newPosition));
        }
        else {
            // Normal behavior
            return vscode_1.commands.executeCommand('deleteLeft');
